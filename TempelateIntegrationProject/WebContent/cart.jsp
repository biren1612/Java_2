...
<html>
   ...
   <body class="sub_page">
      ...
      <section class="product_section layout_padding">
         ...
         <%
         int net_price=0;
         List <Cart> list=CartDao.getCartByUid(u.getUid());
			if (list.size()>0)
			{
		%>
                  ...
                  <div class="box">
                     ...
                     <div class="detail-box">
                        <h6>
                           ...
                           <input type="number" name="product_qty" value="<%=c.getProduct_qty()%>" min="1" max="10" style="width= 20%; height: 20px;" onchange="this.form.submit();">                           
                           </form>
                        </h6>
                     </div>
                     <div class="detail-box">
		...
		<table border="1">
			<tbody>
				...
				<tr>
					...
					<td><input id="CUST_ID" tabindex="2" maxlength="30" size="12" name="CUST_ID" autocomplete="off" value="<%=u.getUid()%>"></td>
				</tr>
				<tr>
					<td>3</td>
